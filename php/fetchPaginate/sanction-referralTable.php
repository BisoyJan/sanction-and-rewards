   ...
   <tbody >';
    if ($total_data > 0) {
        ...
        <tr>
            ...
            <td>' . $row["remark"] . '</td>
            <td>
                <a href="../forms/sanction-action.php" style="text-decoration: none;"> <button class="sanction-actionAddButton btn btn-success" value="' . $row["id"] . '"  type="button">Action</button> </a>
